...
func (p *JSONLPersistence) Create(ctx context.Context, id string) (SessionHandle, error) {
	...
	return &jsonlHandle{store: p.store, id: id, writeMode: true}, nil
}
...
func (p *JSONLPersistence) Open(ctx context.Context, id string, access string) (SessionHandle, error) {
	...
	return &jsonlHandle{store: p.store, id: id, writeMode: writeMode}, nil
}
...
// unused but referenced by interface contract
var _ = time.Now
