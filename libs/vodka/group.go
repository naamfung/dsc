...
// newRouteGroup creates a new RouteGroup with the given path prefix, vodka, and handlers.
func newRouteGroup(prefix string, vodka *Vodka, handlers []Handler) *RouteGroup {
	return &RouteGroup{
		prefix:   prefix,
		vodka:    vodka,
		handlers: handlers,
...
func (rg *RouteGroup) Group(prefix string, handlers ...Handler) *RouteGroup {
	...
	return newRouteGroup((rg.prefix + prefix), rg.vodka, handlers)
}
...
func (rg *RouteGroup) add(method, path string, handlers []Handler) *Route {
	...
	rg.vodka.addRoute(r, combineHandlers(rg.handlers, handlers))
	return r
}
