...
// Package file provides handlers that serve static files for the ozzo vodka package.
package file
...
type ServerOptions struct {
	...
	Allow func(*vodka.Context, string) bool
}
...
//	import (
//	    "log"
//	    "your/project/path/vodka"
//	    "your/project/path/vodka/file"
//	)
//
//	r := vodka.New()
...
//	     "/js": "/ui/dist/js",
//	}))
func Server(pathMap PathMap, opts ...ServerOptions) vodka.Handler {
	...
	return func(c *vodka.Context) error {
		if c.Request.Method != "GET" && c.Request.Method != "HEAD" {
			return vodka.NewHTTPError(vodka.StatusMethodNotAllowed)
		}
		path, found := matchPath(c.Request.URL.Path, from, to)
		if !found || options.Allow != nil && !options.Allow(c, path) {
			return vodka.NewHTTPError(vodka.StatusNotFound)
		}
		...
		if file, err = dir.Open(path); err != nil {
			...
			return vodka.NewHTTPError(vodka.StatusNotFound, err.Error())
		}
		defer file.Close()
...
func Content(path string) vodka.Handler {
