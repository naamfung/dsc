...
type (
	...
	KeyAuthValidator func(string, *vodka.Context) (error, bool)

	keyExtractor func(*vodka.Context) (string, error)
)
...
var (
	...
	DefaultKeyAuthConfig = KeyAuthConfig{
		...
		KeyLookup:  "header:" + vodka.HeaderAuthorization,
		AuthScheme: "Bearer",
	}
)
...
func KeyAuth(fn KeyAuthValidator) vodka.Handler {
...
// See `KeyAuth()`.
func KeyAuthWithConfig(config KeyAuthConfig) vodka.Handler {
	// Defaults
...
func keyFromHeader(header string, authScheme string) keyExtractor {
	return func(c *vodka.Context) (string, error) {
		...
		if header == vodka.HeaderAuthorization {
			l := len(authScheme)
