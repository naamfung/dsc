...
type PluginInfo struct {
	state   protoimpl.MessageState `protogen:"open.v1"`
	Type    string                 `protobuf:"bytes,1,opt,name=type,proto3" json:"type,omitempty"` // 声明类型："llm", "agent", "tool", "policy", "dsc"（dsc 为通用类型）
...
const file_proto_metadata_metadata_proto_rawDesc = "" +
	"\n" +
	"\x1dproto/metadata/metadata.proto\x12\bmetadata\"\a\n" +
	"\x05Empty\"\x98\x02\n" +
	"\n" +
	"PluginInfo\x12\x12\n" +
	...
	"apiVersion\x12J\n" +
	"\fcapabilities\x18\x05 \x03(\v2&.metadata.PluginInfo.CapabilitiesEntryR\fcapabilities\x12\x1a\n" +
	"\bservices\x18\x06 \x03(\tR\bservices\x1a?\n" +
...
var file_proto_metadata_metadata_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
