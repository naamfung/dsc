...
func AddTrailingSlash() vodka.Handler {
...
func AddTrailingSlashWithConfig(config TrailingSlashConfig) vodka.Handler {
	// Defaults
...
func RemoveTrailingSlash() vodka.Handler {
...
func RemoveTrailingSlashWithConfig(config TrailingSlashConfig) vodka.Handler {
	// Defaults
	if config.Skipper == nil {
		config.Skipper = DefaultTrailingSlashConfig.Skipper
	}
