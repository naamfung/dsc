...
func handler1(c *vodka.Context) error {
	return errors.New("abc")
}

func handler2(c *vodka.Context) error {
	c.Write("test")
	return nil
}

func handler3(c *vodka.Context) error {
	panic("xyz")
}

func handler4(c *vodka.Context) error {
	panic(vodka.NewHTTPError(http.StatusBadRequest, "123"))
}
