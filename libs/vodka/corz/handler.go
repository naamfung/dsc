...
// Handler creates a vodka.handler that adds appropriate CORS headers according to the specified options and the request.
func Handler(opts Options) vodka.Handler {
