...
// This method will update the registration of the route in the vodka as well.
func (r *Route) Name(name string) *Route {
	r.name = name
	r.group.vodka.namedRoutes[name] = r
	return r
}
