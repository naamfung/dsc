...
func (manager *Manager) getSid(ctx *vodka.Context) (string, error) {
...
func (manager *Manager) Start(ctx *vodka.Context) (session vodka.RawStore, err error) {
...
func (manager *Manager) Read(sid string) (rawStore vodka.RawStore, err error) {
...
func (manager *Manager) RegenerateId(ctx *vodka.Context) (session vodka.RawStore, err error) {
...
func (m *Manager) Destory(self *vodka.Context) error {
...
func (manager *Manager) sessionID() (string, error) {
	...
	n, err := rand.Read(b)
	if n != len(b) || err != nil {
		return "", fmt.Errorf("could not successfully read from the system CSPRNG. Error: %v", err)
	}
	return hex.EncodeToString(b), nil
}

// Set cookie with https.
func (manager *Manager) isSecure(ctx *vodka.Context) bool {
