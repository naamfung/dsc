...
var (
	...
	DefaultRedirectConfig = RedirectConfig{
		...
		Code:    vodka.StatusMovedPermanently,
	}
)
...
func HTTPSRedirect() vodka.Handler {
	return HTTPSRedirectWithConfig(DefaultRedirectConfig)
}

// HTTPSRedirectWithConfig returns an HTTPSRedirect middleware with config.
// See `HTTPSRedirect()`.
func HTTPSRedirectWithConfig(config RedirectConfig) vodka.Handler {
	// Defaults
...
func HTTPSWWWRedirect() vodka.Handler {
	return HTTPSWWWRedirectWithConfig(DefaultRedirectConfig)
}

// HTTPSWWWRedirectWithConfig returns an HTTPSRedirect middleware with config.
// See `HTTPSWWWRedirect()`.
func HTTPSWWWRedirectWithConfig(config RedirectConfig) vodka.Handler {
	// Defaults
	if config.Skipper == nil {
		config.Skipper = slash.DefaultTrailingSlashConfig.Skipper
	}
...
//
// Usage `vodka#Pre(HTTPSNonWWWRedirect())`
func HTTPSNonWWWRedirect() vodka.Handler {
	return HTTPSNonWWWRedirectWithConfig(DefaultRedirectConfig)
}

// HTTPSNonWWWRedirectWithConfig returns an HTTPSRedirect middleware with config.
// See `HTTPSNonWWWRedirect()`.
func HTTPSNonWWWRedirectWithConfig(config RedirectConfig) vodka.Handler {
	// Defaults
	if config.Skipper == nil {
		config.Skipper = slash.DefaultTrailingSlashConfig.Skipper
	}
...
func WWWRedirect() vodka.Handler {
	return WWWRedirectWithConfig(DefaultRedirectConfig)
}

// WWWRedirectWithConfig returns an HTTPSRedirect middleware with config.
// See `WWWRedirect()`.
func WWWRedirectWithConfig(config RedirectConfig) vodka.Handler {
	// Defaults
	if config.Skipper == nil {
		config.Skipper = slash.DefaultTrailingSlashConfig.Skipper
	}
...
func NonWWWRedirect() vodka.Handler {
	return NonWWWRedirectWithConfig(DefaultRedirectConfig)
}

// NonWWWRedirectWithConfig returns an HTTPSRedirect middleware with config.
// See `NonWWWRedirect()`.
func NonWWWRedirectWithConfig(config RedirectConfig) vodka.Handler {
	if config.Skipper == nil {
		config.Skipper = slash.DefaultTrailingSlashConfig.Skipper
	}
	if config.Code == 0 {
