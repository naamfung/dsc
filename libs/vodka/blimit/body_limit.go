...
import (
	...
	"dsc/libs/vodka"
	lbytes "dsc/libs/vodka/libraries/gommon/bytes"
...
// G, T or P.
func BodyLimit(limit string) vodka.Handler {
...
// See: `BodyLimit()`.
func BodyLimitWithConfig(config BodyLimitConfig) vodka.Handler {
	// Defaults
...
func (r *limitedReader) Reset(reader io.ReadCloser, context *vodka.Context) {
	r.reader = reader
	r.context = context
}
