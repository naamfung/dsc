...
func (st *MemSessionStore) Release(ctx *vodka.Context) error {
	return nil
}
...
func (pder *MemProvider) Read(sid string) (vodka.RawStore, error) {
	pder.lock.RLock()
...
func (pder *MemProvider) Regenerate(oldsid, sid string) (vodka.RawStore, error) {
	pder.lock.RLock()
