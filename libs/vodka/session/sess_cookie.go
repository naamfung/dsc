...
func (st *CookieSessionStore) Release(ctx *vodka.Context) error {
...
func (pder *CookieProvider) Read(sid string) (vodka.RawStore, error) {
...
func (pder *CookieProvider) Regenerate(oldsid, sid string) (vodka.RawStore, error) {
	return nil, nil
}
